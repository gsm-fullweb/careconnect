  ...
  const steps = [
    {
      ...
      description: "Mande uma mensagem para a Mila, sua assistente virtual no WhatsApp. Ela vai entender suas necessidades e ajudar a encontrar um(a) cuidador(a) qualificado(a) que atenda aos seus requisitos específicos, localização e disponibilidade.",
    },
    {
      number: "2",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Como funciona a busca com a Mila?
            </h2>
            <p className="text-lg text-gray-600 mb-8">
              Conecte-se com a Mila pelo WhatsApp e encontre o profissional perfeito de forma rápida, segura e sem estresse!
            </p>
            ...
            <div className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow">
                ...
                <p className="text-gray-600">
                  Basta enviar uma mensagem de voz ou texto solicitando um cuidador. A Mila cuida do resto e encontra o profissional ideal para você.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow">
                ...
                <p className="text-gray-600">
                  Precisa cancelar um agendamento? Apenas avise a Mila e pronto! Sem burocracia, sem complicações.
                </p>
              </div>
            </div>
          </div>
