  ...
  const benefits = [
    {
      ...
      title: "Segurança",
      description: "Buscamos conectar você a profissionais que valorizam a segurança e o bom atendimento",
    },
    {
      icon: <UserCheck className="w-12 h-12 text-[#6B46C1]" />,
      title: "Profissionais Qualificados",
      description: "Filtramos cuidadores com experiência para atender melhor a sua família",
    },
    {
      icon: <Clock className="w-12 h-12 text-[#6B46C1]" />,
      title: "Disponibilidade 24/7",
      description: "Nossa assistente Mila está pronta para iniciar sua busca a qualquer hora",
    },
    {
