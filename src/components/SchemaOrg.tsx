...
// Organization schema for National/Brand pages
export const OrganizationSchema = (props: {
  ...
  const schema = {
    ...
    "@type": "Organization",
    "name": props.name,
    "description": "A CareConnect é uma plataforma que conecta famílias a cuidadores de idosos e facilita a busca por profissionais de acordo com localização, experiência e disponibilidade.",
    "url": `https://www.careconnect.com.br${props.url}`,
    "logo": props.logo || "https://www.careconnect.com.br/images/logo-careconnect.png",
    "sameAs": [
      "https://www.instagram.com/careconnect",
      "https://www.linkedin.com/company/careconnect"
    ]
  };
