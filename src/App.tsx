...
import CuidadorDeIdososMogi from "./pages/CuidadorDeIdososMogi";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/cuidador-de-idosos/mogi-das-cruzes" element={<CuidadorDeIdososMogi />} />
            <Route path="/cuidador-idosos-mogi-das-cruzes" element={<Navigate to="/cuidador-de-idosos/mogi-das-cruzes" replace />} />
            <Route path="/cuidador-mogi-das-cruzes" element={<Navigate to="/cuidador-de-idosos/mogi-das-cruzes" replace />} />
