...
const CuidadorMogiDasCruzes = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Cuidador em Mogi das Cruzes | Ag̻ncia CareConnect Profissional"
        description="Busca por cuidador em Mogi das Cruzes? Cuidadores de idosos qualificados, plant̵es, home care e assist̻ncia em hospitais. Solicite atendimento direto pelo WhatsApp."
        canonical="/cuidador-mogi-das-cruzes"
      />
      <LocalBusinessSchema
        name="CareConnect - Cuidador em Mogi das Cruzes"
        description="Encontre cuidadores em Mogi das Cruzes. Assist̻ncia domiciliar, acompanhantes e plantonistas."
