...
import { MapPin, Briefcase, Clock, CheckCircle2, ChevronLeft, GraduationCap, Heart } from "lucide-react";

export default function BrunaCaroline() {
  const navigate = useNavigate();

  const caregiver = {
    name: "Bruna Caroline de Souza Santos",
    city: "Mogi Das Cruzes",
    state: "SP",
    bairro: "Conjunto Residencial Álvaro Bovolenta",
    experience: "3 a 5 anos",
    education: "Ensino Médio",
    availability: "Segunda a sexta 08h às 18h",
