...
const CuidadorIdososMogiDasCruzes = () => {
  const servicos = [
    ...
    },
    {
      ...
      descricao: "Acompanhamento em internações, consultas e exames nos principais hospitais locais: Santa Casa de Mogi, Hospital Ipiranga, Hospital Santana e Luzia de Pinho Melo.",
    },
    {
