...
export default function DanielaCristina() {
  const navigate = useNavigate();

  const caregiver = {
    name: "Daniela Cristina Cunha",
    city: "Mogi Das Cruzes",
    state: "SP",
    bairro: "Vila Pomar",
    experience: "Menos de 1 ano",
    education: "Ensino Médio",
    availability: "Segunda à quinta feira estou disponível",
    care_category: "Cuidador(a) de Idosos",
    courses: "Atualmente estou fazendo um free-lance de cuidadora de idosos, pois estou gostando muito e pretendo arrumar um emprego fixo, de cuidadora",
    sleep_at_client: false,
    avatar_url: "/images/daniela-cristina.jpeg",
    slug: "daniela-cristina"
  };
