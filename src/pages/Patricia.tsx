...
import { MapPin, Briefcase, Clock, CheckCircle2, ChevronLeft, GraduationCap, CalendarHeart, Heart } from "lucide-react";
...
export default function Patricia() {
  ...
  const caregiver = {
    ...
    availability: "Todos os horários, pois trabalho autônoma como Terapeuta e vendas de planos de Saúde",
    care_category: "Cuidador(a) de Idosos",
    courses: "Acvida em 2023 (Cerca de 84 horas). Conteúdo: Cuidados diários, primeiros socorros, noções de saúde, administração de medicamentos e alimentação saudável.",
    sleep_at_client: true,
    slug: "patricia",
    experience_description: [
      "Experiência como cuidadora de Maria Cecilia Ferrari e Benedito Ferrari, no período de 2020 a 2023.",
      "Sr. Ferrari Faleceu em 2022 e passei a ficar mais proxima da dona Cecilia e antes dela falecer passei até mesmo dar banho!",
      "Atuação nos cuidados diários, acompanhamento da rotina, auxílio nas atividades de vida diária, organização de medicamentos e alimentação, além de atenção ao bem-estar, segurança e conforto dos assistidos.",
      "Fazia Freelancer na clinica de repouso Jardim e também fiz Home Care hospitalar algumas vezes de acompanhante."
    ]
  };
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-gray-600 mb-4">
                <span className="flex items-center gap-1.5">
                  ...
                  {caregiver.bairro}, {caregiver.city} - {caregiver.state}
                </span>
                <span className="flex items-center gap-1.5">
            ...
            <section className="bg-white p-8 rounded-2xl shadow-sm border">
              ...
              <div className="prose text-gray-600">
                <p>
                  ...
                  Atendo na região de {caregiver.bairro}, {caregiver.city}.
                </p>
                <p className="mt-4">
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-4 space-y-2">
                      {caregiver.experience_description.map((paragraph, index) => (
