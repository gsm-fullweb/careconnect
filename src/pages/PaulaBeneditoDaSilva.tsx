...
export default function PaulaBeneditoDaSilva() {
  const navigate = useNavigate();

  const caregiver = {
    name: "Paula Benedito da Silva",
    city: "Mogi das Cruzes",
    state: "SP",
    bairro: "Vila São Paulo",
    experience: "Menos de 1 ano",
    education: "Técnico em Enfermagem",
    availability: "Segunda a sexta 9h às 17h ou 8h às 19h",
    care_category: "Cuidador(a) de Idosos",
    courses: "Técnico em enfermagem - Universidade Bráz Cubas",
    sleep_at_client: true,
    avatar_url: "/images/paula-silva.jpeg",
    slug: "paula-benedito-da-silva"
  };
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                ...
                <Badge variant="outline">{caregiver.care_category}</Badge>
                {caregiver.courses && caregiver.courses.split('-').map(c => <Badge key={c} variant="outline" className="truncate max-w-[250px]">{c.trim()}</Badge>)}
              </div>
            </div>
          ...
          <div className="md:col-span-2 space-y-8">
            <section className="bg-white p-8 rounded-2xl shadow-sm border">
              ...
              <div className="prose text-gray-600">
                <p>
                  Olá! Meu nome é {caregiver.name}, sou cuidadora dedicada e possuo treinamento em cuidar de idosos e pessoas necessitando de assistência.
