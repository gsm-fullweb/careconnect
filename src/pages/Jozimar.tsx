...
export default function Jozimar() {
  ...
  const caregiver = {
    ...
    courses: "Auxiliar de enfermagem",
    avatar_url: "/images/jozimar.jpeg",
    slug: "jozimar",
    experience_description: "Atendimento Home care em residência, paciente com diagnóstico de Demência corpos lewy, cadeirante. Administração de medicamentos VO, banho aspersão, troca de fralda, acompanhamento médico e todo demais auxilio."
  };

  const title = `${caregiver.name} — Cuidador de Idosos em ${caregiver.city} | CareConnect`;
  const description = `Conheça ${caregiver.name}, cuidador profissional de ${caregiver.city}. Veja sua experiência, especialidades e disponibilidade. Solicite atendimento pelo CareConnect.`;
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      <Helmet>
        ...
        <link rel="canonical" href={`https://careconnect.com.br/cuidador/${caregiver.slug}`} />
      </Helmet>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            ...
            <div className="shrink-0 w-full md:w-auto bg-white p-6 rounded-2xl shadow-sm border md:min-w-[280px]">
              ...
              <Button size="lg" className="w-full text-base font-semibold shadow-md" asChild>
                <Link to={`/encontrar-cuidador?interessa=${caregiver.slug}`}>Solicitar este cuidador</Link>
              </Button>
          ...
          <div className="md:col-span-2 space-y-8">
            <section className="bg-white p-8 rounded-2xl shadow-sm border">
              ...
              <div className="prose text-gray-600">
                <p>
                  Olá! Meu nome é {caregiver.name}, sou cuidador dedicado e possuo experiência em cuidar de idosos e pessoas necessitando de assistência.
