...
export default function HosanaRodrigues() {
  const navigate = useNavigate();

  const caregiver = {
    name: "Hosana de Souza Rodrigues",
    city: "Mogi Das Cruzes",
    state: "SP",
    bairro: "Jundiapeba",
    experience: "5 a 10 anos",
    education: "Técnico em Enfermagem",
    availability: "Na semana 12 por 36, 24 por 28",
    care_category: "Cuidador(a) de Idosos",
    courses: "Curso de cuidadora e auxiliar de enfermagem",
    sleep_at_client: true,
    slug: "hosana-rodrigues",
    experience_description: "Todos os cuidados como cuidadora de idoso. De acamados, dispositivo, sondas em geral, alzheimer e parkinson."
  };
