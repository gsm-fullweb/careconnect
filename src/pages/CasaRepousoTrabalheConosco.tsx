...
const CasaRepousoTrabalheConosco = () => {
  const servicos = [
    {
  ...
  return (
    <Layout>
      ...
      <LocalBusinessSchema
        ...
        url="/casa-de-repouso-mogi-das-cruzes-trabalhe-conosco"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Casa de Repouso Vagas <span className="text-[#3e8861]">Trabalhe Conosco</span>
              </h1>
