...
import { MapPin, Briefcase, Clock, CheckCircle2, ChevronLeft, CalendarHeart, Heart, Check } from "lucide-react";

export default function Suellen() {
  ...
  const caregiver = {
    ...
    availability: "Segunda a sexta noturno",
    care_category: "Cuidador(a) de Idosos",
    courses: "Curso de cuidador de idosos em 2018 e 2026 Curso de acompanhante hospitalar",
    avatar_url: "/images/suellen.jpeg",
    slug: "suellen",
    experience_description: [
      "Higiene (Banho, troca de fraldas e autocuidado)",
      "Alimentação (Auxílio nas refeições e hidratação)",
      "Mobilidade (Transferências, locomoção e caminhadas)",
      "Medicação (Administração e controle de remédios)",
      "Monitoramento (Aferição de sinais vitais e acompanhamento)",
      "Posicionamento (Mudança de decúbito/evitar escaras)",
      "Socialização (Atividades recreativas, conversas e estímulo cognitivo)",
      "Oximetria (Aferição frequente da saturação de oxigênio no sangue com o oxímetro)"
    ]
  };
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-2">
                      {caregiver.experience_description.map((item, index) => (
