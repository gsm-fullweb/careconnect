...
const Home = () => {
  return (
    <Layout>
      <SEO
        title="CareConnect | Encontre Cuidadores de Idosos pelo WhatsApp"
        description="A CareConnect ajuda famílias a encontrar cuidadores de idosos de acordo com suas necessidades, localização e disponibilidade. Fale com a Mila pelo WhatsApp."
        canonical="/"
      />
      <OrganizationSchema
        name="CareConnect"
